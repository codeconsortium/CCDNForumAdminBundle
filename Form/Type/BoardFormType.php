...
class BoardFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
	        ...
	        ->add('description', 'bb_editor', array(
	        	'label' => 'ccdn_forum_admin.form.label.board.description',
				'translation_domain' =>  'CCDNForumAdminBundle',
	        ))
	        ->add('readAuthorisedRoles', 'choice', array(
	            'required' => false,
	            'expanded' => true,
	            'multiple' => true,
	        ...
	        ->add('topicCreateAuthorisedRoles', 'choice', array(
	            'required' => false,
	            'expanded' => true,
	            'multiple' => true,
	            'choices' => $options['available_roles'],
	        ...
	        ->add('topicReplyAuthorisedRoles', 'choice', array(
	            'required' => false,
	            'expanded' => true,
	            'multiple' => true,
	            'choices' => $options['available_roles'],
